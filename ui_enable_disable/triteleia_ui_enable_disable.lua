...
local hud_alpha = Channel.keyframe().setDefaultEasing('l').addKey(0,255)
local hud_translationY = Channel.keyframe().setDefaultEasing('l').addKey(0,0)
local hud_translationX = Channel.keyframe().setDefaultEasing('l').addKey(0,0)
local pause_translationX = Channel.keyframe().setDefaultEasing('l').addKey(0,pause_btn.translationX.valueAt(0))
